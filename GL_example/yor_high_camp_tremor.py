...
wdir = '/data/stor/proj/IQ_classes/scripts/seydoux_approach/yor_version/scatseisnet/GL_example/'

saving = True
dirpath_save = wdir+'./tests' # or can be defined in loop to put outputs in different folders
